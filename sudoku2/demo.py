...
from sudoku_solver import EliminateValues, ValidatorTechnique, SudokuSolver, SudokuGenerator

SudokuGenerator.generate_puzzle()

#values = "790000300000006900800030076000005002005418700400700000610090008002300000009000054" # noqa

values = sys.argv[1] if len(sys.argv) > 1 else "." * N_4

# "...71....5..............53.16..2.3......3...9.456......9.2...7.6.....2.3.....6.81"  # noqa
...
# solver = SudokuSolver(state, enable_guessing=True)

# for newstate in solver.solve_iter():
#     StatePrinter.print_state_and_ancestor(newstate)
